								...
								data: {
									move: {
										data: {
											...
											after: "Ход имеет смысл делать всем участникам команды"
										}
									}
								}
							},							
											...
											parts: [												
												{
													...
													parts: [
														{
															type: 'great',													
															info: '10+  Вы одержали победу без особых рисков для окружающих. {Добавьте +1 к последующим броскам} этого события.',
														},
														{
															type: 'partial',													
															info: 'На 7-9  Возникли трудности. Получите {-1 к последующим броскам} этого события.',		
														},
													],													
								...
								data: {
									move: {
										data: {
											...
											condition: "Когда вы [благодаря своей смекалке или умело использованным способностям избежали катастрофы], бросьте +%SUPERIOR% или +%FREAK% соответственно.",
											parts: [												
												{
													type: 'hit',
													info: 'При успехе...',
													parts: [
														{
															type: 'great',													
															info: 'На 10+ город остался в целости и сохранности. Получите {+1 к последующим броскам} этого события.',
														},
														{
															type: 'partial',													
															info: 'На  7-9 пара брошенных машин и загоревшихся зданий не останутся незамеченными. Получите {-1 к последующим броскам} этого события.',		
														},
													],													
											...
											parts: [												
												{
													...
													parts: [
														{
															type: 'great',													
															info: 'На 10+ каждый нуждающийся был спасён. Получите {+1 к последующим броскам} этого события.',
														},
														{
															type: 'partial',													
															info: 'На 7-9 Несколько пострадавших получили ушибы и переломы. Получите {-1 к последующим броскам} этого события.',		
														},
													],													
											...
											parts: [												
												{
													...
													parts: [
														{
															type: 'great',													
															info: 'На 10+ вы отлично постарались, и словами сумели оправдать допущенные ошибки.',
														},
														{
															type: 'partial',													
															info: 'На 7-9 в силу малого опыта общения со СМИ выступление выглядело неуверенно. Люди сомневаются в вас.',		
														},
													],													
